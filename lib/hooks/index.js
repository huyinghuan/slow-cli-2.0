...
function triggerHttpCompilerHook(req, callback) {
    let queue = _HookQueue[map_1.default.route.didRequest];
...
exports.triggerHttpCompilerHook = triggerHttpCompilerHook;
/**
...
function triggerRouterHook(router) {
    let queue = _HookQueue[map_1.default.route.initial];
